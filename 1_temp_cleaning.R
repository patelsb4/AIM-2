...
temp.all <- temp.all %>%
  mutate(HourlyTempF = convert_temperature(HourlyDryBulbTemperature, old_metric = "c", new_metric = "f"))
...
save(daily.temp.all, file='Data/dailytemp.RData')
